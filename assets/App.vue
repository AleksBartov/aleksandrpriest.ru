    ...
    data () {
      return {
        ...
        baptizes: [
          ...
          ['Хочу креститься', 'more_horiz', '/хочу_креститься']
        ],
        testimonials: [
          ['Хочу исповедаться', 'more_horiz', '/хочу_исповедаться'],
          ['Боюсь исповеди', 'more_horiz', '/боюсь_исповеди'],
          ['Ошибки на исповеди', 'more_horiz', '/ошибки_на_исповеди']
        ],
        miniVariant: false,
        right: true,
        rightDrawer: false,
